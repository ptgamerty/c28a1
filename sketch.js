...
function preload() {
  ...
  SHOOTINGCANNONsound = loadSound("assets/cannon_explosion.mp3")
  CANNONSPLASHsound = loadSound("assets/cannon_water.mp3")
...
function showCannonBalls(ball, index) {
  if (ball) {
    ...
    if (ball.body.position.x >= width || ball.body.position.y >= height - 50) {
        ball.remove(index);
        if(!CANNONSPLASHsound.isPlaying()&&!isWaterSplash){
          CANNONSPLASHsound.play()
        }
